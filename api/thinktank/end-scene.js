 ...
 * responses.
 */
import { logThinktankResultToGoogle } from './lib/google-log.js';
import {
    THINKTANK_MODELS,
    callNvidia,
    getJsonBody,
...
import {
    buildManifestSystemPrompt,
    buildManifestUserPrompt
} from './lib/prompts/manifest.js';
    ...
    try {
        ...
        if (!transcript.length) {
            manifest = {
                ...
                situation: 'No public discussion took place in this session.',
                coreProblem: session.goalBrief?.actualQuestion || session.originalProblem || '',
                keyInsights: [],
                disagreements: [],
                recommendation: '',
                risks: [],
            ...
            const systemPrompt = buildManifestSystemPrompt();
            const userPrompt = buildManifestUserPrompt({
            ...
            manifest = {
                ...
                coreProblem: String(parsed.coreProblem || '').trim(),
                keyInsights: normalizeStringArray(parsed.keyInsights),
